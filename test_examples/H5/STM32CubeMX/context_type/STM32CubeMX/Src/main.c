...
static void MX_USART11_Init(void);
...
static void MX_USART11_Init(void)
{
  ...
  husart11.Instance = USART11;
  husart11.Init.BaudRate = 115200;
  husart11.Init.WordLength = USART_WORDLENGTH_8B;
  husart11.Init.StopBits = USART_STOPBITS_1;
  husart11.Init.Parity = USART_PARITY_NONE;
  husart11.Init.Mode = USART_MODE_TX_RX;
  husart11.Init.CLKPolarity = USART_POLARITY_LOW;
  husart11.Init.CLKPhase = USART_PHASE_1EDGE;
  husart11.Init.CLKLastBit = USART_LASTBIT_DISABLE;
  husart11.Init.ClockPrescaler = USART_PRESCALER_DIV1;
  husart11.SlaveMode = USART_SLAVEMODE_DISABLE;
  if (HAL_USART_Init(&husart11) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_USARTEx_SetTxFifoThreshold(&husart11, USART_TXFIFO_THRESHOLD_1_8) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_USARTEx_SetRxFifoThreshold(&husart11, USART_RXFIFO_THRESHOLD_1_8) != HAL_OK)
  {
    Error_Handler();
  }
  if (HAL_USARTEx_DisableFifoMode(&husart11) != HAL_OK)
  {
    Error_Handler();
  }
