...
void HAL_FDCAN_MspDeInit(FDCAN_HandleTypeDef* hfdcan)
{
  ...
  /* USER CODE END FDCAN1_MspDeInit 0 */
    ...
    PD0     ------> FDCAN1_RX
    */
    HAL_GPIO_DeInit(GPIOD, GPIO_PIN_5|GPIO_PIN_0);
...
void HAL_USART_MspDeInit(USART_HandleTypeDef* husart)
{
  ...
  /* USER CODE END USART11_MspDeInit 0 */
    ...
    PF2     ------> USART11_CK
    */
    HAL_GPIO_DeInit(GPIOF, GPIO_PIN_4|GPIO_PIN_3|GPIO_PIN_2);
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  */
    ...
    PeriphClkInitStruct.Sdmmc2ClockSelection = RCC_SDMMC2CLKSOURCE_PLL1Q;
    if (HAL_RCCEx_PeriphCLKConfig(&PeriphClkInitStruct) != HAL_OK)
    {
      Error_Handler();
    }
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  ...
  /* USER CODE END SDMMC2_MspDeInit 0 */
    ...
    PB7     ------> SDMMC2_CKIN
    */
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_10|GPIO_PIN_12|GPIO_PIN_9);
