...
/* USART3_RX */
#define MX_USART3_RX_Pin                       PA5
#define MX_USART3_RX_GPIO_Pin                  GPIO_PIN_5
#define MX_USART3_RX_GPIOx                     GPIOA
...
/* USART3_TX */
#define MX_USART3_TX_Pin                       PA7
#define MX_USART3_TX_GPIO_Pin                  GPIO_PIN_7
#define MX_USART3_TX_GPIOx                     GPIOA
