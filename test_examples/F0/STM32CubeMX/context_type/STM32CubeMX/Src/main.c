...
void SystemClock_Config(void)
{
  ...
  */
  ...
  PeriphClkInit.PeriphClockSelection = RCC_PERIPHCLK_USB|RCC_PERIPHCLK_USART1
                              |RCC_PERIPHCLK_USART2|RCC_PERIPHCLK_CEC
                              |RCC_PERIPHCLK_I2C1;
...
static void MX_TSC_Init(void)
{
  ...
  */
  ...
  htsc.Init.ChannelIOs = TSC_GROUP8_IO1|TSC_GROUP8_IO2;
  htsc.Init.ShieldIOs = TSC_GROUP7_IO3;
  htsc.Init.SamplingIOs = TSC_GROUP7_IO4|TSC_GROUP8_IO3;
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI1_MOSI_DIR_GPIO_Port, SPI1_MOSI_DIR_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED1_Pin|LED2_Pin|LED3_Pin|LED4_Pin
                          |HDMI_HDP_SINK_OD_Pin|SmartCard_CMDVCC_Pin|EX_RESET_OD_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SmartCard_RST_GPIO_Port, SmartCard_RST_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SmartCard_1V8_Pin|SmartCard_3_5V_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : JOY_LEFT_Pin JOY_RIGHT_Pin */
  GPIO_InitStruct.Pin = JOY_LEFT_Pin|JOY_RIGHT_Pin;
  ...
  /*Configure GPIO pin : USB_VBUS_Detection_Pin */
  GPIO_InitStruct.Pin = USB_VBUS_Detection_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(USB_VBUS_Detection_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : HDMI_HDP_SINK_OD_Pin EX_RESET_OD_Pin */
  GPIO_InitStruct.Pin = HDMI_HDP_SINK_OD_Pin|EX_RESET_OD_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);

  /*Configure GPIO pins : IR_IN_Pin SmartCard_OFF_Pin */
  GPIO_InitStruct.Pin = IR_IN_Pin|SmartCard_OFF_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : SmartCard_1V8_Pin SmartCard_3_5V_Pin */
  GPIO_InitStruct.Pin = SmartCard_1V8_Pin|SmartCard_3_5V_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : TempSensor_INT_Pin */
