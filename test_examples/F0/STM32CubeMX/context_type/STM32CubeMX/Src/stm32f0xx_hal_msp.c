...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA1     ------> ADC_IN1
    */
    GPIO_InitStruct.Pin = Potentiometer_Pin|Audio_IN_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC_IN1
    */
    HAL_GPIO_DeInit(GPIOC, Potentiometer_Pin|Audio_IN_Pin);
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE BEGIN CAN:CEC_CAN_IRQn disable */
    /**
    * Uncomment the line below to disable the "CEC_CAN_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(CEC_CAN_IRQn); */
  /* USER CODE END CAN:CEC_CAN_IRQn disable */
...
void HAL_CEC_MspInit(CEC_HandleTypeDef* hcec)
{
  ...
  /* USER CODE END CEC_MspInit 0 */
    ...
    PB8     ------> CEC
    */
    GPIO_InitStruct.Pin = HDMI_CEC_OD_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF0_CEC;
    HAL_GPIO_Init(HDMI_CEC_OD_GPIO_Port, &GPIO_InitStruct);
...
void HAL_CEC_MspDeInit(CEC_HandleTypeDef* hcec)
{
  ...
  /* USER CODE END CEC_MspDeInit 0 */
    ...
    PB8     ------> CEC
    */
    HAL_GPIO_DeInit(HDMI_CEC_OD_GPIO_Port, HDMI_CEC_OD_Pin);

    /* CEC interrupt DeInit */
  /* USER CODE BEGIN CEC:CEC_CAN_IRQn disable */
    /**
    * Uncomment the line below to disable the "CEC_CAN_IRQn" interrupt
    * Be aware, disabling shared interrupt may affect other IPs
    */
    /* HAL_NVIC_DisableIRQ(CEC_CAN_IRQn); */
  /* USER CODE END CEC:CEC_CAN_IRQn disable */
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PB3     ------> SPI1_SCK
    */
    HAL_GPIO_DeInit(GPIOE, SPI1_MISO_Pin|SPI1_MOSI_Pin);
...
void HAL_TSC_MspDeInit(TSC_HandleTypeDef* htsc)
{
  ...
  /* USER CODE END TSC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOD, TS1_Pin|TS2_Pin|TS_CT_Pin);
